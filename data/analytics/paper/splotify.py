...
def main():
    ...
    for feature in FEATURES:
        ...
        plt.xlabel(cfg.get("xlabel", "Step"), fontsize=20)
        plt.ylabel(cfg.get("ylabel", feature), fontsize=20)
        plt.tick_params(labelsize=14)  # Set font size for axis tick labels (graduations)
        plt.legend(title="Run", loc="best", fontsize=16, title_fontsize=16)
        plt.tight_layout()
